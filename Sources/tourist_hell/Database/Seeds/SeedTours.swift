        ...
        func prepare(on database: any Database) async throws {
            let tours = [
                Tour(
                    name: "Brazil madness",
                    description:
                        "Take yourself on a journey with hot Brazillian men and see the real Brazil by yourself.",
                ...
                Tour(
                    ...
                    description:
                        "Experience the breathtaking beauty of Japan during cherry blossom season.",
                ...
                Tour(
                    ...
                    description:
                        "Explore the vibrant souks, majestic deserts, and ancient cities of Morocco.",
                ...
                Tour(
                    ...
                    description:
                        "Embark on an unforgettable wildlife safari through Kenya's stunning savannas.",
                ...
                Tour(
                    ...
                    description:
                        "Indulge in the art, history, and cuisine of Italy’s most romantic cities.",
